...
class DFNet(nn.Module):
    ...
    def evaluate(self, dev, matric_best, output=False, early_stop=None):
        ...
        if args['dataset'] == 'kvr':
            ...
            print("P-micro-sche SCORE:\t{}".format(P_sche_score))
            print("P-micro-wea SCORE:\t{}".format(P_wea_score))
            print("P-micro-nav SCORE:\t{}".format(P_nav_score))
            print("R-micro SCORE:\t{}".format(R_score))
            print("R-micro-sche SCORE:\t{}".format(R_sche_score))
            print("R-micro-wea SCORE:\t{}".format(R_wea_score))
            print("R-micro-nav SCORE:\t{}".format(R_nav_score))
            ...
            F1_score = self.compute_F1(P_score, R_score)
            print("P-micro SCORE:\t{}".format(P_score))
            print("P-micro-restaurant SCORE:\t{}".format(P_restaurant_score))
            print("P-micro-attraction SCORE:\t{}".format(P_attraction_score))
            print("P-micro-hotel SCORE:\t{}".format(P_hotel_score))
            print("R-micro SCORE:\t{}".format(R_score))
            print("R-micro-restaurant SCORE:\t{}".format(R_restaurant_score))
            print("R-micro-attraction SCORE:\t{}".format(R_attraction_score))
            print("R-micro-hotel SCORE:\t{}".format(R_hotel_score))
            print("F1-micro SCORE:\t{}".format(F1_score))
